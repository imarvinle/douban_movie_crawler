...
'''
-------------------------------------------------
   Description :  简单映射map,主要是对豆瓣数据做一些清洗
   Author :       lichunlin
   date：          2018/12/31
-------------------------------------------------
'''

provinces = ["客家","福建", "顺德","闽南","甘肃", "陕西","重庆","贵州独山","云南", "青岛","武汉", "东北","吴越", "苏州", "河南", "安徽","四川",
            "方", "京剧", "沪", "上海", "北京", "山西", "湖北", "湖南", "江西", '江苏', "新疆", "河北", '吉林', '辽宁', '黑龙江',
            "东北", '西南',"西北", '东南', '天津', '浙江', "江西","山东", '广东','海南','贵州', '甘肃',"青海", '台湾',"徐州"]

language_map = {"汉语普通话": "汉语", "美国": "英语", "加拿大": "英语", "四川话": "汉语", "山西话": "汉语", "俄罗斯": "俄语",
                "印度": "印度语", "中国大陆": "汉语", "德国": "德语", "香港": "粤语", "意大利": "意大利语", "英国": "英语",
                "日本": "日语", "西安话": "汉语", "台湾": "汉语", "南京话": "汉语", "上海话": "汉语", "唐山话": "汉语", "韩国": "韩语",
                "重庆话": "汉语", "美国手语": "手语","福建话": "闽南语", "法国":"法语", "越南":"越语", "加拿大 Canada":"英语","青岛话":"汉语",
                "武汉话":"汉语", "云南方言":"汉语", "东北话":"汉语", "中文":"汉语", "26": "汉语","河南方言":"汉语", "安徽方言":"汉语", "贵州方言":"贵州方言",
                "印度  India":"印度语", "西班牙":"西班牙语", "瑞典":"瑞典语","澳大利亚":"英语","泰国":"泰语" ,"普通话":"汉语"}


for province in provinces:
    language_map[province] = "汉语"
    language_map[province+"语"]  = "汉语"
    language_map[province+"方言"] = "汉语"
    language_map[province+"话"] = "汉语"
...
nameMap['英语'] = 'United States of America'
nameMap['新加坡'] = 'Singapore'
nameMap['韩语'] = 'South Korea'
nameMap['波黑'] = 'Bosnia'
nameMap['美属萨摩亚 American Samoa'] = 'American Samoa'
nameMap['新喀里多尼亚 New Caledonia'] = 'New Caledonia'
nameMap['印度 India'] = 'India'
nameMap['(U.S.'] = 'United States of America'
nameMap['马耳他'] = 'Malta'
nameMap['汉语普通话'] = 'China'
nameMap["汉语"] = "China"
nameMap["河南方言"] = "China"
